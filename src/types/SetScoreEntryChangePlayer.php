 ...
 * @see SetScorePacket
 */
final class SetScoreEntryChangePlayer extends SetScorePayloadEntry{
	public const ID = ScorePacketEntryActionType::CHANGE_PLAYER;
	...
	public static function read(ByteBufferReader $in) : self{
		...
		$playerUniqueId = CommonTypes::getActorUniqueId($in); //same wire encoding (VarInt signed long)
		return new self($scoreboardId, $objectiveName, $scoreValue, $playerUniqueId);
	}
